# GS-102-refined-candidate Notes

> Tier 1 engineering candidate; not signed validation; not benchmark agreement.

## Purpose

This case keeps the refined GS-102 OpenRadioss source fixture. The retained
...
```sh
python3 scripts/gen_gs102_refined_deck.py
```

Run repeatable transient candidates with:

```sh
python3 scripts/gs102_transient_candidate_pipeline.py \
  --case-id <case-id> \
  --source-case-dir golden_samples/GS-102-refined-candidate/data
```
