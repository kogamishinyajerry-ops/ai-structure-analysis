...
function App() {
  ...
  const { trustStrip, sections: trustSections } = useTrustSections({
    ...
    latestEvent,
    solverLogSummary,
    solverLogState: solverLogState ?? null,
    convergenceSummary,
    ...
    backendProvenance,
    meshArtifactSource,
    candidateMeshEvidence: candidateMeshEvidence ?? null,
    convergenceArtifactList,
    meshConvergenceStudySource,
    meshConvergenceStudy: meshConvergenceStudy ?? null,
    meshConvergenceClaimImpact,
    referenceStatus,
    referenceReason,
    referenceDeviation,
    unitSummary,
    candidateAssumptions: candidateAssumptions ?? null,
    materialSummary,
    boundarySummary,
    meshTopologySummary,
    ...
    failurePatternRef,
    candidateBallistic: candidateBallistic ?? null,
    ...
    ballisticTimeStepStudy: ballisticTimeStepStudy ?? null,
    ballisticTier2BlockerSummary,
    reviewerSummary,
    candidateReviewer: candidateReviewer ?? null,
